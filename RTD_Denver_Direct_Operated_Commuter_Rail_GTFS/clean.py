...
df = pd.read_csv('./RTD_Denver_Direct_Operated_Commuter_Rail_GTFS/stops.txt')
...
# print(df1.to_csv('./RTD_Denver_Direct_Operated_Commuter_Rail_GTFS/stops.txt',index=False))
...
final_df.to_csv('./RTD_Denver_Direct_Operated_Commuter_Rail_GTFS/stops.txt', index=False)
