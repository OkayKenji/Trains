...
df = pd.read_csv('./RTD_Denver_Purchased_Transportation_Commuter_Rail_GTFS/stops.txt')
...
# df1.to_csv('./e.csv',index=False)
# print(df1.to_csv('./RTD_Denver_Purchased_Transportation_Commuter_Rail_GTFS/stops.txt',index=False))
...
final_df.to_csv('./RTD_Denver_Purchased_Transportation_Commuter_Rail_GTFS/stops.txt', index=False)
