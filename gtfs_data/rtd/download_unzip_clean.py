...
extract_to = './gtfs_data/rtd/RTD_Denver_Direct_Operated_Commuter_Rail_GTFS'
...
subprocess.run(['python', f'./gtfs_data/rtd/RTD_Denver_Direct_Operated_Commuter_Rail_GTFS/clean.py'])
...
extract_to = './gtfs_data/rtd/RTD_Denver_Purchased_Transportation_Commuter_Rail_GTFS'
...
subprocess.run(['python', f'./gtfs_data/rtd/RTD_Denver_Purchased_Transportation_Commuter_Rail_GTFS/clean.py'])
